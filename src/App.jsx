...
const SKILLS = {
  WordPress: [
    ...
    { name: "Plugin Development", level: 85, icon: SiWordpress },
    { name: "WordPress APIs", level: 82, icon: SiWordpress },
    { name: "Hooks & Filters", level: 85, icon: SiWordpress },
    { name: "WooCommerce", level: 75, icon: SiWoocommerce },
    { name: "Custom WP Development", level: 80, icon: SiWordpress },
  ],
  Languages: [
    { name: "JavaScript", level: 82, icon: SiJavascript },
    { name: "PHP", level: 80, icon: SiPhp },
    { name: "Python", level: 85, icon: SiPython },
    { name: "TypeScript", level: 68, icon: SiTypescript },
    { name: "HTML", level: 88, icon: SiHtml5 },
  ...
  Backend: [
    ...
    { name: "FastAPI", level: 78, icon: SiFastapi },
    { name: "PHP", level: 80, icon: SiPhp },
    { name: "REST APIs", level: 85, icon: SiChainlink },
  ],
  "Database & Tools": [
...
const PROJECTS = [
  ...
  },
  {
    ...
    description:
      "A modern futuristic real-estate platform designed with premium UI/UX, interactive experiences, and responsive performance-focused architecture for a seamless digital property showcase. The project is for a client",
    tech: ["React JS", "Tailwind CSS", "Framer Motion"],
    features: [
      "Designed and developed a modern futuristic real-estate website for a client.",
      "Built responsive and interactive UI with smooth animations and premium UX.",
      "Created dynamic property showcase sections with modern glassmorphism design.",
  ...
  features: [
    "Built a custom WordPress admin-bar interface for instantly activating and deactivating extensions.",
    "Implemented real-time AJAX-based extension switching without requiring users to visit the Plugins page.",
    "Developed a Troubleshooting Mode that temporarily disables selected extensions and restores their exact previous state.",
    "Designed a client-side search and grouping system for quickly finding active and inactive extensions.",
  ],
  color: "#6366f1",
  icon: "",
  ...
  description:
    "A Chrome Extension built to monitor WordPress.org support forums in real time. Tracks new support tickets and customer replies awaiting agent response, with intelligent duplicate prevention, live notifications, and a dynamic support queue.",
  tech: [
    "JavaScript",
    "Chrome Extensions",
    "Manifest V3",
  ...
  features: [
    ...
    "Smart detection of pending support requests",
    "Duplicate-free notification system",
    "Live support queue with unread tracking",
    "Persistent local storage and badge counters",
  ],
  color: "#ff5630",
  icon: "",
...
const EXPERIENCE = [
  {
    role: "Software Engineer, WordPress Products",
    company: "Ollyo",
    period: "2024 – Present",
    location: "Dhaka, Bangladesh",
    points: [
      "Contribute to the development and maintenance of WordPress-based products and plugins used across high-traffic web applications.",
"Work across PHP, JavaScript, HTML and CSS to debug and resolve application-level issues in production environments.",
"Investigate and fix frontend and backend bugs, working directly with WordPress hooks, actions, filters and database queries.",
"Collaborate closely with developers, QA and product teams to reproduce issues, review code, and ship reliable fixes.",
"Work with REST APIs and third-party integrations to improve the performance, reliability and maintainability of WordPress applications.",
"Use Git/GitHub as part of a modern development workflow to track, review and deploy changes, while communicating effectively in a remote collaboration environment."
    ],
    color: "#00d4ff",
  },
...
const REVIEWS = [
  ...
  },
  {
    id: 8,
    // Replace with your actual screenshot URL or import
    image: "https://snipboard.io/gL7pZt.jpg",
    client: "",
    role: "",
    company: "",
    platform: "Trustpilot",
  ...
  },
  {
    id: 9,
    // Replace with your actual screenshot URL or import
    image: "https://snipboard.io/H6YfXE.jpg",
    client: "",
    role: "",
    company: "",
    platform: "Trustpilot",
...
function Hero() {
  ...
  const phrases = ["Software Engineer", "WordPress Developer", "Full-Stack Web Developer", "PHP & JavaScript Developer", "Django & FastAPI Dev"];
  ...
  const badges = ["WordPress", "PHP", "JavaScript", "React", "Django", "FastAPI", "REST APIs", "MySQL"];
        ...
        <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem", alignItems: "center" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 15, color: "rgba(255,255,255,0.5)", lineHeight: 1.8, maxWidth: 460, margin: "1rem 0 1.8rem", fontFamily: "'DM Sans', sans-serif" }}>
              Software engineer with hands-on experience building and maintaining WordPress-based
              products, plugins, and full-stack web applications. Passionate about clean code,
              scalable architecture, and solving complex engineering challenges.
            </p>
  ...
  const modules = [
    {
      ...
      desc: "Plugin development & custom features",
      className: "m1",
    },
    {
    ...
    },
    {
      ...
      desc: "Optimization & query intelligence",
      className: "m3",
    },
    {
      title: "PRODUCTION DEBUGGING",
      desc: "Diagnosing & fixing complex bugs",
      className: "m4",
    },
  ];

  return (
    <section className="ironman-about">
      {/* BACKGROUND */}
      ...
      <div className="top">
        ...
        {/* KEEP YOUR HEADING FONT */}
        <SectionTitle>
          Software engineer building{" "}
          <span>modern web & WordPress-powered systems</span>
        </SectionTitle>
      </div>
      ...
      <div className="hud-wrapper">
        ...
        <div className="side-panel left-panel">
          ...
          <div className="panel-content">
            ...
            <p>
              Software engineer with practical experience in the WordPress
              ecosystem, building scalable APIs and full-stack web applications.
            </p>
        ...
        <div className="center-system">
          ...
          {/* SVG CONNECTIONS */}
          <svg className="system-svg" viewBox="0 0 900 900">
            <path d="M450 450 C 300 260, 240 240, 140 220" />
            <path d="M450 450 C 620 260, 680 240, 760 220" />
            <path d="M450 450 C 300 650, 240 680, 140 700" />
            <path d="M450 450 C 620 650, 680 680, 760 700" />
          </svg>

          {/* FLOATING MODULES */}
          {modules.map((mod) => (
            <div key={mod.title} className={`module ${mod.className}`}>
      ...
      <style>{`
        ...
        /* =========================================
   RESPONSIVE FIX
   REPLACE YOUR RESPONSIVE SECTION WITH THIS
========================================= */
...
//   const links = [
//     { label: "Email", value: "saha.dipofficial171@gmail.com", href: "mailto:saha.dipofficial171@gmail.com", color: "#00d4ff", icon: SiGmail },
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Open to Software Engineer and WordPress Developer roles,
          ...
          <div>
            ...
            >
              ...
              <div>
                ...
                >
                  Open to Software Engineer and WordPress
                  Developer roles, plus select freelance
                  projects. Prefer remote positions.
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <footer style={{ background: "#03060f", borderTop: "1px solid rgba(255,255,255,0.05)", padding: "2rem 1.5rem", textAlign: "center" }}>
      ...
      <p style={{ fontSize: 12, color: "rgba(255,255,255,0.22)", fontFamily: "'DM Sans', sans-serif", marginBottom: "0.4rem" }}>
        Dip Saha · Software Engineer · WordPress Developer · Full-Stack Web Developer · Dhaka, Bangladesh
      </p>
